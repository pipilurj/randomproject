...
class SegmentationCodebookDataset(Dataset):
    ...
    # loc: 0; sep: 1; eos: 2
    def __init__(self, path="/home/pirenjie/data/coco/annotations/instances_train2017.json", downsample_num_upper=24,
                 downsample_num_lower=16, transformation=True, size=None, num_bins=64):
        self.coco = COCO(path)
