...
class SegmentationDataset(Dataset):
    ...
    def __init__(self, path="/home/pirenjie/data/coco/annotations/instances_train2017.json", downsample_num_upper=24,
                 downsample_num_lower=16, transformation=True, size =None):
        self.coco = COCO(path)
    ...
    def load_segment_scale(self, index):
        ...
        return segment_array_anchor, segment_array_pos, np.array([w, h])
    ...
    def __getitem__(self, index):
        ...
        segment_array_negative, _, _ = self.load_segment_scale(random.choice(self.legal_indices))
...
if __name__ == "__main__":
    ...
    seg_dataset = SegmentationDataset("/home/pirenjie/data/coco/annotations/instances_train2017.json", transformation=False)
    loader = DataLoader(seg_dataset, batch_size=10000, collate_fn=custom_collate_fn)
